...
namespace CateringPro.WebApi.Tests.Unit.Services
{
    ...
    public class ControllerActionTests
    {
        ...
        [Fact]
        public async Task CreateAsync_ValidatorContainsErrors_DoesNotInvokeUseCaseAndDoesNotSaveChanges()
        {
            // Arrange
            var _CancellationToken = new CancellationToken();
            var _Command = "Command";
        ...
        [Fact]
        public async Task ReadAsync_ValidatorContainsErrors_DoesNotInvokeUseCase()
        {
            // Arrange
            var _CancellationToken = new CancellationToken();
            var _Command = "Command";
        ...
        [Fact]
        public async Task UpdateAsync_ValidatorContainsErrors_DoesNotInvokeUseCaseAndDoesNotSaveChanges()
        {
            // Arrange
            var _CancellationToken = new CancellationToken();
            var _Command = "Command";
