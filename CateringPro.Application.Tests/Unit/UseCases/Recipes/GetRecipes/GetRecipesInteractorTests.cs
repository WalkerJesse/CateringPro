...
namespace CateringPro.Application.Tests.Unit.UseCases.Recipes.GetRecipes
{
    ...
    public class GetRecipesInteractorTests
    {
        ...
        public async Task HandleAsync_ValidRequest_Successful()
        {
            ...
            var _Request = new GetRecipesRequest();
            var _Response = new GetRecipesResponse();
            ...
            _MockMapper
                ...
                .Returns(_RecipeDtos);
            _MockMapper
                .Setup(mock => mock.Map<GetRecipesResponse>(_RecipeDtos))
                .Returns(_Response);
            ...
            var _MockPresenter = new Mock<IPresenter<GetRecipesResponse>>();
            ...
            _MockMapper.Verify(mock => mock.Map<GetRecipesResponse>(_RecipeDtos), Times.Once);
